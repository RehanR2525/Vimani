                            ...
                            <Slider {...settings}>
                                {
                                    todayDeal?.map((data) => (
                                        <div className='px-3'>
                                            <img src={data.products[0].product.option_set[0].productimage_set[0].image} style={{ height: '120px', width: '140px' }} alt="" />
                                            {/* <img src={data.products[0].product.option_set[0].productimage_set[0].image} style={{ height: '120px', width: '100%' }} alt="" /> */}
                                        </div>
                                    ))
                                }
                            </Slider>
                            ...
                            <Slider {...settings}>
                                {
                                    brands?.map((data) => (
                                        <div className='px-3'>
                                            <img src={data.products[0].product.option_set[0].productimage_set[0].image} style={{ height: '100px', width: '100px' }}></img>
                                        </div>
                                    ))
                                }
                            </Slider>
                                        ...
                                        <Row>
                                            {
                                                seasonData?.map((data) => (
                                                    <Col lg={6} xs={6} className='my-2'>
                                                        <div className='pl-2'>
                                                            <img src={data.products[0].product.option_set[0].productimage_set[0].image} style={{ height: '120px', width: '120px' }} alt="" />
